(() => {
  ...
  var displayMap = (locationsData) => {
    mapboxgl.accessToken = "pk.eyJ1IjoibGVvbmxvbnNkYWxlIiwiYSI6ImNsZ3dxbG1wMjAycG4zcW56M2o3NDI3YmoifQ.E60vanneX04NABbrZCCvwQ";
    const map = new mapboxgl.Map({
      container: "map",
      // container ID
      style: "mapbox://styles/leonlonsdale/clgwstxud009v01pg9czj2sjm",
      // style URL
      scrollZoom: false
    });
    const bounds = new mapboxgl.LngLatBounds();
    locationsData.forEach((location2) => {
      const marker = document.createElement("div");
      marker.className = "marker";
      new mapboxgl.Marker({
        element: marker,
        anchor: "bottom"
        // bottom of the pin is on the geolocation
